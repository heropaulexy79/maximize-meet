...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Welcome back to the Nation!");
        ...
        <Card className="border-white/10 bg-black/40 backdrop-blur-2xl shadow-2xl overflow-hidden rounded-[2rem]">
          <CardHeader className="space-y-2 pt-10 pb-6 px-8">
            ...
            <CardDescription className="text-center text-muted-foreground text-base">
              Enter your credentials to access the Leadership Room.
            </CardDescription>
          </CardHeader>
          <CardContent className="px-8 pb-8">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-black px-2 text-muted-foreground tracking-widest">Or continue with</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button 
                ...
                className="h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 transition-all"
              >
              ...
              <Button 
                ...
                className="h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 transition-all"
              >
                <svg className="mr-2 h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
